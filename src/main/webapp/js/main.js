let url = `http://ws.audioscrobbler.com/2.0/?method=chart.gettoptracks&limit=7&api_key=${YOUR_API_KEY}&format=json`;
...
fetch(url)
	  .then((response) => {
		...
		tracks.forEach((track)=>{
			...
			url = `http://ws.audioscrobbler.com/2.0/?method=track.getInfo&api_key=${YOUR_API_KEY}=${artist}&track=${trackName}&format=json`;
