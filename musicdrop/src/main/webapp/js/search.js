...
function autoComplete(){
	...
	let url = `http://ws.audioscrobbler.com/2.0/?method=track.search&track=${keyword}&limit=10&api_key=${API_KEY}&format=json`;
...
function showResult(){
	...
	let url = `http://ws.audioscrobbler.com/2.0/?method=album.search&album=${keyword}&limit=10&api_key=${API_KEY}&format=json`;
